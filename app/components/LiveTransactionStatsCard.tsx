    ...
    return (
        <div className="card">
            ...
            <div className="alert alert-warning m-2" role="alert">
                Note: Ping stastics are best effort in monitoring network performance. The data is not guaranteed to be
                accurate and is not a reliable indicator of cluster health.
            </div>
